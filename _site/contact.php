...
<script>
  (function() {
    var cx = '016656741306535874023:kjn7wq42k2g';
...
<div class="j-header">
  <div class="name">
    <h1>International Journal of Civil Infrastructure (IJCI)<!-- <br><p class="body">ISSN: 2368-5964</p> --></h1>
    <div class="oalink">
    ...
    <img src="../img/journals/j-ijci.jpg" class="j-img">
</div>
</div>

<div class="desktop jhead">
  <div class="name">
    <h1>International Journal of Civil Infrastructure (IJCI)</h1>
    <div class="issn">
